...
public class AccountClerkSignup extends Frame implements ActionListener,WindowListener{
	...
	public AccountClerkSignup(WelcomePage f){
		super("Account Clerk Register");
		welcomePage=f;
		Label l=new Label("Account clerk Name");
		Label l2=new Label("Password (must be 5 charecter)");
		Label l3=new Label("Confirm Password");
		Label l4=new Label("phone Number");
		Label l5=new Label("Gender");
		Label l6=new Label("Age");
		Label l7=new Label("Working Hour");
		Label l8=new Label("Working Shift");
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(s.equals("Register")){
			...
			{
				JOptionPane.showMessageDialog(this,"password must be 5 charecter");
			}
			else{
				String q="insert into accountclerk values(null,'"+tf.getText()+"','"+tf2.getText()+"','"+tf4.getText()+"','"+tf6.getText()+"','"+tf7.getText()+"','"+tf8.getText()+"')";
