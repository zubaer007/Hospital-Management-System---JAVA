...
public class DoctorSignup extends Frame implements ActionListener,WindowListener{
	...
	public DoctorSignup(WelcomePage f){
		super("Doctor Signup");
		welcomePage=f;
		Label l=new Label("Doctor Name");
		Label l2=new Label("Password (must be 3 charecter )");
		Label l3=new Label("Confirm Password");
		Label l4=new Label("phone Number");
		Label l5=new Label("Mail Address");
		Label l6=new Label("Gender");
		Label l7=new Label("Age");
		Label l8=new Label("Specialist in");
		tf=new TextField(28);
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(s.equals("Register")){
			...
			else if( tf2.getText().length()!=3)
			{
				JOptionPane.showMessageDialog(this,"password must be 3 charecter");
			}
			else{
				String q="insert into doctor values(null,'"+tf.getText()+"','"+tf2.getText()+"','"+tf4.getText()+"','4-5','"+tf8.getText()+"','"+tf7.getText()+"','"+tf5.getText()+"')";
